...
export const archiveEntries = [
  {
    ...
    descriptionKhmer:
      "ពិធីបុណ្យចូលឆ្នាំថ្មី គឺជាការប្រារព្វធ្វើបីអាទិ៍ ដើម្បីបង្ហាញពីការបញ្ចប់រដូវប្រមូលផល ដោយមានការលេងល្បែងប្រពៃណី ការទៅវត្ត និងការប្រោះទឹកអប់រំ",
    descriptionEnglish:
  ...
  },
  {
    ...
    descriptionKhmer:
      "ពិធីបុណ្យភ្ជុំបិណ្ឌ គឺជាបុណ្យសាសនាដែលមានរយៈពេល ១៥ អាទិ៍ ដែលប្រជាជនខ្មែរថ្វាយបង្គំដល់បុព្វបុរស តាមរយៈការថ្វាយស្បៀងអាហារនៅតាមវត្តអារាម",
    descriptionEnglish:
  ...
  },
  {
    ...
    descriptionKhmer:
      "ព្រះរាជពិធីបុណ្យអុំទូក ប្រារព្វធ្វើជាកិត្តិយសដល់ការបញ្ច្រាសលំហូរទន្លេសាប ដោយមានការប្រណាំងទូកនៅមុខរាជធានីភ្នំពេញ និងផ្ទាំងគោមអណ្តែតទឹកនៅពេលយប់",
    descriptionEnglish:
  ...
  },
  {
    ...
    descriptionKhmer:
      "ពិធីបុណ្យមាឃបូជា ជាកិត្តិយសដល់ធម្មទេសនាចុងក្រោយរបស់ព្រះពុទ្ធ ចំពោះព្រះសង្ឃ ១២៥០ អង្គ ដែលបានមកជួបជុំគ្នាដោយឯកឯង ដោយឥតមានការកោះហៅ",
    descriptionEnglish:
  ...
  },
  {
    ...
    titleEnglish: "Royal Plowing Ceremony (Preah Reach Pithi Chrot Preah Nongkoal)",
